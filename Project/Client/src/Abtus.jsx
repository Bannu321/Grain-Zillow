      ...
      <div id="team-container" className={styles.teamContainer}>
        ...
        <div className={styles.teamMember}>
          <img
            ...
            className={styles.memberImage}
          />
          <h3 className={styles.memberName}>Aditya Krishna</h3>
          <p className={styles.memberRole}>Backend Developer</p>
          <p className={styles.memberDescription}>Building secure and scalable backend logic for device integration.</p>
        </div>
