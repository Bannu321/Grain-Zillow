...
export default function GrainZillowLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        // SUCCESS: Backend authentication passed
      ...
      alert("Cannot connect to server. Please check if backend is running on http://localhost:5000");
    } finally {
      setAuthenticating(false);
    }
  };
  ...
  return (
    <div className="top-images">
      {/* Top Left Logo */}
      <Link className="top-left-img" to="/">
